...
if(isset($_POST['acao'])){
    ...
    $path = "../../../models/playlists_uploads/metal/".$arquivo['name'];
...
<body>
    ...
    <center>
        <div class="container">
            <h1><strong>Metal</strong></h1>
            <img src="../capa_playlists/metal.jpg">
            ...
            <?php 
                $arquivos = scandir("../../../models/playlists_uploads/metal");
                unset($arquivos[1]);
                unset($arquivos[0]);
                ...
                foreach($arquivos as $arquivo) {
                    ...
                    <center>
                        ...
                        <audio controls>
                            <source src='../../../models/playlists_uploads/metal/".$arquivo."' type='audio/ogg'>
