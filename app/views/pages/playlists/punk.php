...
if(isset($_POST['acao'])){
    ...
    $path = "../../../models/playlists_uploads/punk/".$arquivo['name'];
...
<body>
    ...
    <center>
        <div class="container">
            <h1><strong>Punk</strong></h1>
            <img src="../capa_playlists/punk.jpg">
            ...
            <?php 
                $arquivos = scandir("../../../models/playlists_uploads/punk");
                unset($arquivos[1]);
                unset($arquivos[0]);
                ...
                foreach($arquivos as $arquivo) {
                    ...
                    <center>
                        ...
                        <audio controls>
                            <source src='../../../models/playlists_uploads/punk/".$arquivo."' type='audio/ogg'>
