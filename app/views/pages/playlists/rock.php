...
if(isset($_POST['acao'])){
    ...
    $path = "../../../models/playlists_uploads/rock/".$arquivo['name'];
...
<body>
    ...
    <center>
        <div class="container">
            <h1><strong>Rock</strong></h1>
            <img src="../capa_playlists/rock.jpg">
            ...
            <?php 
                $arquivos = scandir("../../../models/playlists_uploads/rock");
                unset($arquivos[1]);
                unset($arquivos[0]);
                ...
                foreach($arquivos as $arquivo) {
                    ...
                    <center>
                        ...
                        <audio controls>
                            <source src='../../../models/playlists_uploads/rock/".$arquivo."' type='audio/ogg'>
