...
if(isset($_POST['acao'])){
    ...
    $path = "../../../models/playlists_uploads/rap/".$arquivo['name'];
...
<body>
    ...
    <center>
        <div class="container">
            <h1><strong>Rap</strong></h1>
            <img src="../capa_playlists/rap.jpg">
            ...
            <?php 
                $arquivos = scandir("../../../models/playlists_uploads/rap");
                unset($arquivos[1]);
                unset($arquivos[0]);
                ...
                foreach($arquivos as $arquivo) {
                    ...
                    <center>
                        ...
                        <audio controls>
                            <source src='../../../models/playlists_uploads/rap/".$arquivo."' type='audio/ogg'>
