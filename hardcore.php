...
if(isset($_POST['acao'])){
    ...
    $path = "../../../models/playlists_uploads/hardcore/".$arquivo['name'];
...
<body>
    ...
    <center>
        <div class="container">
            <h1><strong>Hardcore</strong></h1>
            <img src="../capa_playlists/hardcore.jpg">
            ...
            <?php 
                $arquivos = scandir("../../../models/playlists_uploads/hardcore");
                unset($arquivos[1]);
                unset($arquivos[0]);
                ...
                foreach($arquivos as $arquivo) {
                    ...
                    <center>
                        ...
                        <audio controls>
                            <source src='../../../models/playlists_uploads/hardcore/".$arquivo."' type='audio/ogg'>
